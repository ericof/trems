...
2. Go to your repository at [ericof/trems](https://github.com/ericof/trems).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `trems-ericof.tangrama.com.br` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | trems-ericof.tangrama.com.br | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | trems-ericof.tangrama.com.br |
...
- [Backend Tests Workflow](https://github.com/ericof/trems/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/ericof/trems/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/ericof/trems-backend`) and Frontend (`ghcr.io/ericof/trems-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of trems-ericof.tangrama.com.br](https://github.com/ericof/trems/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/trems-ericof.tangrama.com.br.yml` stack.
