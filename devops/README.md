...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trems-ericof.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    trems-ericof.tangrama.com.br:
      ansible_user: root
      host: trems-ericof
      hostname: trems-ericof.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trems-ericof.tangrama.com.br.yml` to the remote server with:
